...
class Customer(TenantBaseModel, SoftDeleteMixin):
    """
    ...
    __table_args__ = (
        ...
        UniqueConstraint('tenant_id', 'login', name='uq_customer_tenant_login'),
...
class CustomerDebt(TenantBaseModel):
    """
...
class CustomerGroup(TenantBaseModel, SoftDeleteMixin):
    ...
    __table_args__ = (
        ...
        UniqueConstraint('tenant_id', 'name', name='uq_custgroup_tenant_name'),
    )


class CustomerGroupMember(TenantBaseModel):
    """
...
class LoyaltyPoints(TenantBaseModel):
    """
