...
class CashRegister(TenantBaseModel):
    ...
    __table_args__ = (
        ...
        UniqueConstraint('tenant_id', 'code', name='uq_cashreg_tenant_code'),
    )
...
class ExpenseCategory(TenantBaseModel):
    ...
    __table_args__ = (
        ...
        UniqueConstraint('tenant_id', 'name', name='uq_expcat_tenant_name'),
    )


class CashShift(TenantBaseModel):
    """
...
class BankAccount(TenantBaseModel):
    ...
    __table_args__ = (
        ...
        UniqueConstraint('tenant_id', 'account_number', name='uq_bank_tenant_accnum'),
    )
...
class DailyReport(TenantBaseModel):
    """
    ...
    __table_args__ = (
        ...
        UniqueConstraint('tenant_id', 'report_date', name='uq_dailyrep_tenant_date'),
    )
