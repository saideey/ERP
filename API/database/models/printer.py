...
class Printer(TenantBaseModel, SoftDeleteMixin):
    """
    ...
    agent_token = Column(String(100), nullable=True)  # Token for print agent auth
...
class UserPrinter(TenantBaseModel):
    """
...
class PrintJob(TenantBaseModel):
    """
