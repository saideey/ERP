...
class SMSTemplate(TenantBaseModel):
    """
    ...
    code = Column(String(50), nullable=False)  # sale_complete, debt_reminder, etc.
    ...
    __table_args__ = (
        ...
        UniqueConstraint('tenant_id', 'name', name='uq_smstempl_tenant_name'),
        UniqueConstraint('tenant_id', 'code', name='uq_smstempl_tenant_code'),
    )
...
class ScheduledTask(TenantBaseModel):
    """
...
class FileAttachment(TenantBaseModel):
    """
...
class ReportExport(TenantBaseModel):
    """
