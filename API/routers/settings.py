...
@router.get(
    "/limits",
    summary="Tarif cheklovlari va joriy foydalanish"
)
async def get_tenant_limits(
    ...
    """
    Get current tenant usage vs limits.
    Shows: users, products, warehouses — current count and max allowed.
    """
    from services.tenant_limits import get_tenant_usage
